<?php echo form_open('teammember/add',array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="TeamId" class="col-md-4 control-label">TeamId</label>
		<div class="col-md-8">
			<input type="text" name="TeamId" value="<?php echo $this->input->post('TeamId'); ?>" class="form-control" id="TeamId" />
		</div>
	</div>
	<div class="form-group">
